...
description: >-
  ...
  Il n'est applicable que sur Alystia !
---

# 📗 Règlement Illégal

{% hint style="success" %}
Merci de lire attentivement le règlement ci-dessous. Il doit être appris mais surtout compris afin d'avoir une immersion cohérent et fluide une fois en jeu. Il n'est applicable que sur Alystia!
{% endhint %}
...
\
Pour les dossiers fait un ticket sur notre discord illégal Alystia\
\
...
\- Si un shooter lors d'une descente se fait abattre, c'est un CK pour lui. \
...
\- Refuser d’ouvrir son coffre ou donner son arme, est compté comme un refus de scène. Si vous jugez que la scène n’est pas légitime, merci de faire un Report après la scène ou d'ouvrir un ticket sur le discord de Alystia. (Nous avons les Logs)
...
\- Il est interdit de contacter l'équipe staff en privé à propos de quelque chose concernant Alystia illégal. (les Tickets sont là pour ça)
